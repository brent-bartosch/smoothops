...
/**
 * update-system.mjs — Safe auto-updater for smoothops
 *
...
const CANONICAL_REPO = 'https://github.com/brent-bartosch/smoothops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/brent-bartosch/smoothops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/brent-bartosch/smoothops/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'smoothops-update-checker',
        },
